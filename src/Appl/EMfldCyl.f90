...
! EMfldCylclass: ElectroMagnetic field data container class
...
!----------------------------------------------------------------
      module EMfldCylclass
        ...
        interface setparam_EMfldCyl
          module procedure setparam1_EMfldCyl,  &
                           setparam2_EMfldCyl, setparam3_EMfldCyl
        end interface
      contains
        subroutine construct_EMfldCyl(this,numseg,nmpstp,type,blength)
        implicit none
        type (EMfldCyl), intent(out) :: this
        ...
        end subroutine construct_EMfldCyl
   
        subroutine setparam1_EMfldCyl(this,i,value)
        implicit none
        type (EMfldCyl), intent(inout) :: this
        integer, intent(in) :: i
        double precision, intent(in) :: value

        this%Param(i) = value

        end subroutine setparam1_EMfldCyl
        ...
        end subroutine setparam2_EMfldCyl
        ...
        end subroutine setparam3_EMfldCyl
        ...
        end subroutine getparam1_EMfldCyl
        ...
        end subroutine getparam2_EMfldCyl

        subroutine getparam3_EMfldCyl(this,blength,bnseg,bmapstp,&
                                       btype)
        implicit none
        type (EMfldCyl), intent(in) :: this
        ...
        end subroutine getparam3_EMfldCyl
...
!        call getaxfldE_EMfldCyl(t,this,ein,e1in,e2in)
        call getaxfldEfc_EMfldCyl(t,this,ein,e1in,e2in)
        ...
        call rk6i_EMfldCyl(h,mpstp,t0,y,18,this,Bchg,Bmass)
        ...
        sqf3=sqrt(uf)**3
        tfin = t + tau
!        call getaxfldE_EMfldCyl(tfin,this,ef,e1f,e2f)
        call getaxfldEfc_EMfldCyl(tfin,this,ef,e1f,e2f)
        ...
        end subroutine maplinear_EMfldCyl
        ...
        tint=t
        do i=1,ns
          call intfunc1_EMfldCyl(t,y,f,this,Bchg,Bmass)
          a=h*f
          yt=y+a/9.d0
          tt=t+h/9.d0
          call intfunc1_EMfldCyl(tt,yt,f,this,Bchg,Bmass)
          b=h*f
          yt=y + (a + 3.d0*b)/24.d0
          tt=t+h/6.d0
          call intfunc1_EMfldCyl(tt,yt,f,this,Bchg,Bmass)
        ...
        zedge = this%Param(1)
!        call getaxfldE_EMfldCyl(t,this,ez1,ezp1,ezpp1)
        call getaxfldEfc_EMfldCyl(t,this,ez1,ezp1,ezpp1)
        ww = this%Param(3)/Scfreq 
        theta0 = this%Param(4)*asin(1.0)/90 
        qmcc = Bchg/Bmass
        ...
        end subroutine intfunc1_EMfldCyl
...
!        endif
  101   format(6(1x,1pe13.6))
        ...
        end subroutine getaxfldE_EMfldCyl
        ...
        end subroutine getaxfldEfc_EMfldCyl
...
! This is based on the assumption of azmuthal symmetry and TM mode.
        ...
        end subroutine getfld_EMfldCyl
...
! This is based on the assumption of azmuthal symmetry and TM mode.
        ...
        end subroutine getflderrold_EMfldCyl

        !--------------------------------------------------------------------------------------
        !> @brief
        !> get external field with displacement and rotation errors.
        !--------------------------------------------------------------------------------------
        subroutine  getflderr_EMfldCyl(pos,extfld,this,dx,dy,anglex,angley,anglez)
        implicit none
        include 'mpif.h'
        double precision, dimension(4), intent(in) :: pos
        type (EMfldCyl), intent(in) :: this
...
! This is based on the assumption of azmuthal symmetry and TM mode.
        ...
        end subroutine getflderr_EMfldCyl
...
! Here, we have only Er, Ez, and Btheta for TM mode.
        ...
        end subroutine getfld6_EMfldCyl
        
        subroutine getfld6err_EMfldCyl(this,pos,extfld,dx,dy,anglex,angley,&
                                    anglez)
        type (EMfldCyl), intent(in) :: this
        double precision, dimension(4), intent(in) :: pos 
        double precision, intent(in) :: dx,dy,anglex,angley,anglez
        ...
        end subroutine getfld6err_EMfldCyl
...
! Here, we have only Er, Ez, and Btheta for TM mode.
        ...
        end subroutine getfld6xyz_EMfldCyl
        
        subroutine getfld6xyzerr_EMfldCyl(this,pos,extfld,dx,dy,anglex,angley,&
                                    anglez)
        type (EMfldCyl), intent(in) :: this
        double precision, dimension(4), intent(in) :: pos 
        double precision, intent(in) :: dx,dy,anglex,angley,anglez
        ...
        end subroutine getfld6xyzerr_EMfldCyl
        ...
        double precision, dimension(6), intent(out) :: extfld
        double precision :: hz,hr,zz,efz,efr,er,ez,bt,rr,tmpcos,tmpsin
        double precision :: escale,ww,theta0,tt,z
        integer :: iz,iz1,ir,ir1
        ...
        if((z.gt.this%Param(1)).and.(z.lt.(this%Param(1)+this%Length))) then
          !print*,"ZmaxRf: ",fldata%ZmaxRft,fldata%ZminRft,fldata%NzIntvRft 
          escale = this%Param(2)
          ...
          tmpcos = cos(ww*tt+theta0)*escale
          tmpsin = -sin(ww*tt+theta0)*escale
!          tmpcos = sin(ww*tt+theta0)*escale
!          tmpsin = cos(ww*tt+theta0)*escale
          zz = z-this%Param(1)
          ...
          ! get the external field along "r" at given "z" by linear interpolation
          ! Here, we have only Er, Ez, and Btheta for TM mode.
          er = (fldata%erdatat(iz,ir)*(1.0-efz)*(1.0-efr)+&
               fldata%erdatat(iz1,ir)*efz*(1.0-efr)+&
               fldata%erdatat(iz1,ir1)*efz*efr+fldata%erdatat(iz,ir1)*&
               (1.0-efz)*efr)*tmpcos
          ez = (fldata%ezdatat(iz,ir)*(1.0-efz)*(1.0-efr)+fldata%ezdatat(iz1,ir)*&
               efz*(1.0-efr)+&
               fldata%ezdatat(iz1,ir1)*efz*efr+fldata%ezdatat(iz,ir1)*&
               (1.0-efz)*efr)*tmpcos
          bt = (fldata%btdatat(iz,ir)*(1.0-efz)*(1.0-efr)+fldata%btdatat(iz1,ir)*&
               efz*(1.0-efr)+&
               fldata%btdatat(iz1,ir1)*efz*efr+fldata%btdatat(iz,ir1)*&
               (1.0-efz)*efr)*tmpsin
 
          extfld(1) = er*pos(1)/rr
          extfld(2) = er*pos(2)/rr
          extfld(3) = ez
!          extfld(4) = 0.0
!          extfld(5) = 0.0
!          extfld(6) = 0.0
          extfld(4) = -bt*pos(2)/rr
          extfld(5) = bt*pos(1)/rr
          extfld(6) = 0.0
        else
          extfld = 0.0
        endif
!        write(15,100)z,1.0*ir,1.0*iz,er/tmpcos,ez/tmpcos,bt/tmpsin,&
!         efz,efr,fldata%erdatat(iz,ir),fldata%erdatat(iz,ir1),&
!         fldata%ezdatat(iz,ir),fldata%ezdatat(iz,ir1),fldata%btdatat(iz,ir),&
!         fldata%btdatat(iz,ir1)
!        extfld = 0.0
                     
100     format(14(1x,e13.6))

        end subroutine getfldt_EMfldCyl

      end module EMfldCylclass
